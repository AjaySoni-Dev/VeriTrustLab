...
- Do not commit model weights, local model conversions, provider captures, or benchmark fixtures containing sensitive content; use the approved artifact registry and document pinning, licensing, evaluation, and review evidence for model changes.
