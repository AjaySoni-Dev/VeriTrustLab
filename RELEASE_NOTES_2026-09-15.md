...
Release intent: product build focused on evidence-aware email threat detection, infrastructure provenance, campaign correlation, and cryptographic evidence verification, deployable only with the compatible external runtime/database contract described below.
