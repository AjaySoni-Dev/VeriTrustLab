...
function passportPayload({ scanId, evidence, decision = null }) {
  ...
  return {
    ...
    statement: 'This signature verifies the integrity of the packaged VeriTrust Lab evidence. It does not identify a person, guarantee message safety, or independently establish legal admissibility.',
  };
}
