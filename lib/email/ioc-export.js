...
function toStixBundle(scanId, evidence) {
  ...
  const objects = iocs.map((ioc) => ({
    ...
    created: generated,
    modified: generated,
    name: `VeriTrust Lab observed email artifact: ${ioc.type}`,
    description: `Observed during VeriTrust Lab email investigation ${scanId}. Sources: ${ioc.sources.join(', ') || 'email evidence'}. This export does not independently classify the artifact as malicious.`,
