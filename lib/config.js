...
const serverConfig = {
  ...
  get linkAnalysisConcurrency() {
    return getOptionalInteger('VERITRUST_LINK_ANALYSIS_CONCURRENCY', VERITRUST_RUNTIME_DEFAULTS.linkAnalysisConcurrency, { minimum: 1, maximum: 8 });
  },
