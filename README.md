...
| Evidence Passport | SHA-256-bound Ed25519 signed evidence manifests with trusted-issuer verification. Public full-package integrity verification requires both the passport and evidence object; JSON/STIX 2.1/IOC CSV export is supported. |
