(function caseWorkspace(global) {
  ...
  function renderCaseList(cases) {
    ...
    if (!rows.length) {
      target.innerHTML = '<div class="empty-state-table"><strong>No email cases match this queue.</strong><p>Change the filters or run a new email investigation. Eligible completed email investigations become review cases automatically.</p></div>';
      return;
    }
