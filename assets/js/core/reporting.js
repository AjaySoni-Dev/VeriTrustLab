    ...
    return {
      ...
      result: {
        ...
        disclaimer:
          result.disclaimer ||
          report.disclaimer ||
          'AI-assisted result. Not a legal conclusion, independent forensic certification, cybersecurity certification, or final proof.',
      },
    ...
    return `
      <section class="report-section detail-section">
        <div class="section-heading">
          ...
          <span>Available scan metadata</span>
        </div>
        ...
        <main class="report-sheet" data-report-template="${REPORT_TEMPLATE_VERSION}">
          <div class="report-frame">
            ...
            <footer class="disclaimer">
              ${escapeHtml(result.disclaimer || report.report.disclaimer || 'AI-assisted result. Not a legal conclusion, independent forensic certification, cybersecurity certification, or final proof.')}
            </footer>
          </div>
        </main>
      </body>
