...
PowerShell Core is not installed in this Linux build container, so the Windows parser/dress-rehearsal step must be run on the two actual demo laptops before judging.
